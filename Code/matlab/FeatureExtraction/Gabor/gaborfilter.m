...
function [Eim, Oim, Aim] = gaborfilter(im, wavelength, angle, kx, ky, showfilter)
    if nargin == 5
        showfilter = 0;
    end
    ...
    Eim = Eim( wavelength*kx*2: rows-wavelength*kx*2, wavelength*ky*2: cols-wavelength*ky*2 );
    Oim = Oim( wavelength*kx*2: rows-wavelength*kx*2, wavelength*ky*2: cols-wavelength*ky*2 );
    Aim = Aim( wavelength*kx*2: rows-wavelength*kx*2, wavelength*ky*2: cols-wavelength*ky*2 );
