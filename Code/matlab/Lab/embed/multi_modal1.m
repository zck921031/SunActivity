...
for modal = 1 : 9
    ...
    [L,~] = lmnn2(xTr, yTr,3,L0,'maxiter',5000,'quiet',1,'outdim',3,'mu',0.5,'validation', 0.2,'earlystopping',25,'subsample', 0.3 );
...
[L,~] = lmnn2(linxTr, linyTr, 3, 'diagonal', 1, 'maxiter',5000,'quiet',1, 'mu',0.5,'validation', 0.1,'earlystopping',25,'subsample',0.3);
...
for i = 1 : 3
    subplot(2,2,i);
    h = legend('Algo.1.Eucli', 'Algo.1.PCA', 'Algo.1.diag'); hold on;
    set(h,'box','off')
end
