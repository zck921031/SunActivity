...
% Last Modified by GUIDE v2.5 06-Apr-2015 13:56:20
...
%load filenames;
%imshow( imread(['C:\Users\zck\Documents\GitHub\SunActivity\data\regional annotation\img\', Names{1,1}] ) );
...
% handles    structure with handles and user data (see GUIDATA)
disp('go pre day');
day1 = str2double( get(handles.day,'String') ) - 1;
day1 = max(1, day1);
set(handles.day, 'String', num2str(day1) );
...
% Hints: contents = cellstr(get(hObject,'String')) returns wave contents as cell array
%        contents{get(hObject,'Value')} returns selected item from wave
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    onRecognition(hObject, eventdata, handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    saveFeedback(hObject, eventdata, handles);